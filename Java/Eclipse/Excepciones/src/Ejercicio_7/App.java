...
public class App {
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println(sociedad.calcularAlturaMediaHombres());
			
			System.out.println(sociedad.calcularAlturaMediaMujeres());
			
			System.out.println(sociedad.calcularAlturaMedia());
		}catch(ParametroIntroducidoIncorrectoException e) {
